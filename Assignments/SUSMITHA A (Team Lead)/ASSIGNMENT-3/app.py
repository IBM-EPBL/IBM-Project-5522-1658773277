...
COS_API_KEY_ID =  "NXFxlqxYZCG90bbfqcHVcv6uOy6hb1q5uLa9gRFSVY80"
COS_INSTANCE_CRN =  "crn:v1:bluemix:public:cloud-object-storage:global:a/78af54c17a8d42368edbeb975ed33b99:f764add9-9c0f-44e2-9986-215c2af7d582::"
...
@app.route('/')
def index():
    files = get_bucket_contents('susmitha-ibm')
